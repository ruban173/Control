   ...
   public partial class GisForm : Form
   {
    ...
    /*  void AddGpsMobileLogRoutes(string file)
      ...
      void MainMap_OnTileLoadStart()
      {
         MethodInvoker m = delegate()
         {
            panelMenu.Text = "Меню: загрузка плиток...";
         };
         try
         {
            BeginInvoke(m);
      ...
      void MainMap_OnTileLoadComplete(long ElapsedMilliseconds)
      {
         ...
         MethodInvoker m = delegate()
         {
            panelMenu.Text = "Меню, последняя загрузка  " + MainMap.ElapsedMilliseconds + "ms";
      ...
      private void LoadDataSubCompanies()
        ...
        private void LoadSubCompRegions()
        {
            ...
            foreach (var item in company)
            {
                ...
                var GMarkerColor= GMarkerGoogleType.pink;
                switch ((int)item.id_subsidiary_companies)
                {
                    case 1: GMarkerColor = GMarkerGoogleType.green; break;
                    case 2: GMarkerColor = GMarkerGoogleType.blue; break;
                    case 3: GMarkerColor = GMarkerGoogleType.yellow; break;
                }


                GMapMarker m = new GMarkerGoogle(pos, GMarkerColor);
                {
